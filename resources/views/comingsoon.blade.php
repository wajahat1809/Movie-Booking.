...
<div class="section-padding height-auto-100 image-flip-rtl" style="background: url('assets/images/pages/coming-soon.html'); background-size: cover; background-repeat: no-repeat; position: relative;min-height:500px">
