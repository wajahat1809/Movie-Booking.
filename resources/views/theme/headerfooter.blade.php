...
<!-- Mirrored from templates.iqonic.design/streamit-dist/frontend/html/home.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Oct 2024 13:53:05 GMT -->
<head>
  <meta charset="utf-8">
                  ...
                  <div class="d-flex gap-3 gap-xl-0 align-items-center">
                     ...
                     <div class="logo-default">
                         <a class="navbar-brand text-primary" href="index.html"> 
                             <img class="img-fluid logo" src="assets/images/logo.html" loading="lazy" alt="streamit" />
                         </a>
                     </div>
                     <div class="logo-hotstar">
                         <a class="navbar-brand text-primary" href="index.html"> 
                             <img class="img-fluid logo" src="assets/images/logo-hotstar.html" loading="lazy" alt="streamit" />
                         </a>
                     </div> 
                     <div class="logo-prime">
                         <a class="navbar-brand text-primary" href="index.html"> 
                             <img class="img-fluid logo" src="assets/images/logo-prime.html" loading="lazy" alt="streamit" />
                         </a>
                     </div> 
                     <div class="logo-hulu">
                         <a class="navbar-brand text-primary" href="index.html"> 
                             <img class="img-fluid logo" src="assets/images/logo-hulu.html" loading="lazy" alt="streamit" />
                         </a>
                     </div>
                    ...
                    <div class="container-fluid p-lg-0">
                      ...
                      <ul class="navbar-nav iq-nav-menu  list-unstyled" id="header-menu">
                        ...
                        <li class="nav-item">
                          ...
                          <li class="nav-item">
                         <a class="btn btn mt-1" href="/login" role="button">Login</a>
                         </li>
                       <li class="nav-item">
                      <a class="btn btn mt-1" href="/register" role="button">Register</a>
                     </li>
                        </li>
                      </ul>
                    </div>
                        ...
                        <ul class="navbar-nav align-items-center ms-auto mb-2 mb-xl-0">
                           ...
                           <li class="nav-item dropdown" id="itemdropdown1">
                              ...
                              <ul class="dropdown-menu dropdown-menu-end dropdown-user border-0 p-0 m-0"
                                 ...
                                 <li>
                                    <a href="/myaccount" class="iq-sub-card d-flex align-items-center gap-3">
          ...
          <div class="col-md-3">
            ...
            <div class="d-flex align-items-center">
              <a class="app-image" href="#">
                <img src="assets/images/footer/google-play.html" loading="lazy" alt="play-store" />
              </a>
              <br />
              <a class="ms-3 app-image" href="#">
                <img src="assets/images/footer/apple.html" loading="lazy" alt="app-store" />
              </a>
            </div>
          </div>
        </div>
...
<!-- Mirrored from templates.iqonic.design/streamit-dist/frontend/html/home.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Oct 2024 13:53:54 GMT -->
</html>