      ...
      <div class="col-lg-8">
        ...
        <form class="mb-5 mb-lg-0">
          <div class="row">
            ...
            @csrf
              <input type="text" class="form-control font-size-14" name="name" placeholder="Your Name*" required>
            </div>
            <div class="col-md-6 mb-4 mb-lg-5">
              <input type="text" class="form-control font-size-14" name="last" placeholder="Last Name*" required>
            </div>
            <div class="col-md-6 mb-4 mb-lg-5">
              <input type="tel" class="form-control font-size-14" maxlength="140" minlength="10" name="number" placeholder="Phone Number*" required>
            </div>
            <div class="col-md-6 mb-4 mb-lg-5">
              <input type="email" class="form-control font-size-14" name="email" placeholder="Your Email*" required>
            </div>
            <div class="col-md-12 mb-4 mb-lg-5">
              <textarea class="form-control font-size-14" cols="40" rows="10" name="message" placeholder="Your Message"></textarea>
            </div>
            <div class="col-md-12">
              <div class="iq-button">
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="contact-box d-flex gap-3 rounded mb-3 mb-lg-0">
          <img src="assets/images/pages/box-pattern.html" class="img-fluid position-absolute top-0 end-0" alt="pattern">
